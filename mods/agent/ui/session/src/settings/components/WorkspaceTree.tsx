...
import { type WorkspaceData, WorkspaceNode } from './WorkspaceNode.tsx';
...
export function WorkspaceTree({
  ...
  const fetchWorkspaceData = useCallback(async function fetchWorkspaceData(
    path: string,
  ...
  function clearWorktreeSelectionIfNeeded() {
    ...
    if (selection.workspaceIndex === workspaceIndex && selection.worktreeName === worktree.name) {
