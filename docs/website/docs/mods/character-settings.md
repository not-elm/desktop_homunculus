...
- **Right-click a character** and select **"Character Settings"** from the [context menu](./menu)
...
- The Character Settings MOD adds a "Character Settings" entry to the [Context Menu](./menu).
