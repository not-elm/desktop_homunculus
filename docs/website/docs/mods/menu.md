...
**Right-click on a character** to open the context menu. The menu shows the character's name and a list of available actions. Actions are contributed by other installed MODs — for example, the [Persona](./persona) MOD adds a "Persona" entry.
