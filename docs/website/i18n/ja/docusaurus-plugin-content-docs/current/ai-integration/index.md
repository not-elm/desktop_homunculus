...
ツールの完全なリファレンスは [MCP リファレンス](/docs/reference/mcp-tools)をご覧ください。
...
テンプレート MOD の作成や MCP ツールの改善に貢献したい場合は、[コントリビューティングガイド](/docs/contributing)をご覧ください。

## 次のステップ {#next-steps}

- **[AI クライアントのセットアップ](./setup/claude-desktop)** — 数分で接続
- **[MCP 機能の確認](/docs/reference/mcp-tools)** — 20 のツール、4 つのリソース、3 つのプロンプトの完全なリファレンス
- **[MOD を作成する](/docs/mod-development/quick-start)** — より豊かな AI ワークフローのためのテンプレート MOD を作成
