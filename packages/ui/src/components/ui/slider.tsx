  ...
  return (
    ...
    >
      <SliderPrimitive.Track
        ...
        className={cn(
          "bg-input relative grow overflow-hidden rounded-full data-[orientation=horizontal]:h-2 data-[orientation=horizontal]:w-full data-[orientation=vertical]:h-full data-[orientation=vertical]:w-2 backdrop-blur-md border border-border"
        )}
      >
        <SliderPrimitive.Range
          ...
          className={cn(
            ...
            "bg-gradient-to-r from-holo-cyan via-holo-violet to-holo-rose"
          )}
        />
      </SliderPrimitive.Track>
