  ...
  render: (_args) => (
    <Accordion type="single" collapsible className="w-[400px]">
      <AccordionItem value="item-1">
        ...
        <AccordionContent>
          Desktop Homunculus is a cross-platform desktop mascot application built with the Bevy game
          engine. It renders transparent-window VRM 3D characters with WebView-based UI overlays.
        </AccordionContent>
      </AccordionItem>
      <AccordionItem value="item-2">
        <AccordionTrigger>How do I install mods?</AccordionTrigger>
        <AccordionContent>
          Mods are NPM packages installed in the mods root directory. Each mod declares its assets
          and scripts in package.json under the &quot;homunculus&quot; field.
        </AccordionContent>
      </AccordionItem>
      <AccordionItem value="item-3">
        <AccordionTrigger>Can I customize the character?</AccordionTrigger>
        <AccordionContent>
          Yes. You can load any VRM model and apply animations using VRMA files. The SDK provides
          APIs for controlling poses, expressions, and effects.
        </AccordionContent>
      </AccordionItem>
    </Accordion>
  ),
  ...
  render: (_args) => (
    <Accordion type="multiple" defaultValue={['item-1']} className="w-[400px]">
      <AccordionItem value="item-1">
        ...
        <AccordionContent>
          This section starts expanded. Other sections can also be opened without closing this one.
        </AccordionContent>
      </AccordionItem>
      <AccordionItem value="item-2">
