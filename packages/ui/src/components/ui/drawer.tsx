  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          "holo-shimmer holo-refract-border holo-noise [--holo-refract-fill:var(--popover)] group/drawer-content bg-popover backdrop-blur-xl fixed z-50 flex h-auto flex-col shadow-holo-lg",
          ...
          "data-[state=open]:[animation:holo-drawer-in_300ms_ease-out] data-[state=closed]:[animation:holo-drawer-out_200ms_ease-in]",
          className
        )}
        {...props}
      >
        <div className="mx-auto mt-4 hidden h-1.5 w-[60px] shrink-0 rounded-full bg-muted-foreground/30 group-data-[vaul-drawer-direction=bottom]/drawer-content:block" />
        {children}
      </DrawerPrimitive.Content>
    </DrawerPortal>
  )
