...
const sceneStyles: Record<string, React.CSSProperties> = {
  ...
  checkerboard: {
    backgroundImage: 'repeating-conic-gradient(oklch(0.2 0 0) 0% 25%, oklch(0.15 0 0) 0% 50%)',
 ...
 */
export function withSceneLayer(
  ...
  // biome-ignore lint/correctness/useHookAtTopLevel: Storybook decorator, not a React component
  React.useEffect(() => {
