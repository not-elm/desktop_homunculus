...
//! - [`SignalsApi`](prelude::SignalsApi): Signal-based pub/sub messaging
...
use crate::character::CharacterApiPlugin;
...
pub mod prelude {
    pub use crate::{
        ...
        audio::*,
        cameras::*,
        character::{CharacterApi, CharacterInfo},
        display::*,
        effects::*,
        entities::*,
        error::*,
